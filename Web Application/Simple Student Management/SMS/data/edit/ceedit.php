...
<body>
    ...
    <div id="outer">
        <div id="inner">
            ...
            <h2 >Edit Student Information</h2><hr>
            <div>
                <div>
                Serial Number     <br>
                Roll     <br>
            ...
            <?php
                if(isset($_POST["Submit"])){
                    ...
                    $sqle= "UPDATE ce SET roll=$roll,firstname='$firstname',lastname='$lastname',fname='$fname',mname='$mname',regn=$regn,phone=$phone,email='$email',address='$address',session=$session,addate= '$addate'
                    WHERE roll =$temp";
                    try{
