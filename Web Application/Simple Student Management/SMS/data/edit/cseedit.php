        ...
        <div id="inner">
            ...
            <?php
                if(isset($_POST["Submit"])){
                    ...
                    $sqle= "UPDATE cse SET roll=$roll,firstname='$firstname',lastname='$lastname',fname='$fname',mname='$mname',regn=$regn,phone=$phone,email='$email',address='$address',session=$session,addate= '$addate'
                    WHERE roll =$temp";
                    try{
